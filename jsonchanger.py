...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QLabel, QPushButton, QFileDialog,
                             QMessageBox, QHBoxLayout, QComboBox, QDoubleSpinBox, QSpinBox, QGroupBox, QTabWidget)
...
class JsonConfigEditor(QWidget):
    def __init__(self):
        ...
        self.parameters = {
            ...
            "wall_line_width_0": ("走线宽度(外壁)", "float", ["settings", "resolution", "children", "line_width", "children", "wall_line_width_0", "default_value"], 0.001, 2),
            "wall_line_width_x": ("走线宽度(内壁)", "float", ["settings", "resolution", "children", "line_width", "children", "wall_line_width_x", "default_value"], 0.001, 2),
    ...
    def setupTabs(self):
        groups = {
            ...
            "走线宽度设置": ["line_width", "wall_line_width", "wall_line_width_0", "wall_line_width_x", "initial_layer_line_width_factor"],
            "壁设置": ["wall_thickness", "wall_line_count", "optimize_wall_printing_order", "wall_ordering", "z_seam_type"],
            "顶层/底层设置": ["top_bottom_thickness", "top_thickness", "top_layers", "bottom_thickness", "bottom_layers", "initial_bottom_layers"],
            "填充设置": ["infill_sparse_density", "infill_line_distance", "infill_pattern", "connect_infill_lines", "infill_multiplier", "infill_overlap_percentage", "infill_overlap_mm", "infill_wipe_distance", "infill_sparse_thickness"]
        }
    ...
    def loadJson(self):
        ...
        self.file_path, _ = QFileDialog.getOpenFileName(self, "选择 JSON 配置文件", "", "All Files (*);;JSON Files (*.json)", options=options)
        if self.file_path:
            try:
